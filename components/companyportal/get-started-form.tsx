        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
              Join organizations committed to authentic environmental progress. Fill in your details and we'll reach out
              within 12 hours.
            </p>
          </div>
            ...
            {submitted ? (
              <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-lg p-8 md:p-12 text-center">
                ...
                <p className="text-gray-300 mb-6">
                  We've received your details and will reach out to you within the next 12 hours. We'll send a sign-in
                  password to your email address.
                </p>
                <p className="text-sm text-gray-400 mb-8">
                  In the meantime, feel free to explore our solutions and methodologies.
                </p>
                <Button onClick={() => (window.location.href = "/")} className="bg-accent text-white hover:opacity-90">
                  Back to Home
                </Button>
              </div>
            ) : (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="plantCompanyName" className="text-sm font-medium text-white">
                      Plant/Company Name *
                    </label>
                    <Input
                      id="plantCompanyName"
