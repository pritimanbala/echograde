			...
			<div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
				<div className="text-center mb-8">
					<a
						...
						<span className="text-4xl font-bold text-green-600">ECHO</span>
						<span className="text-4xl font-bold text-gray-800">grade</span>
					</a>
				...
				<form
					...
					className="space-y-4 flex align-center justify-center flex-col">
					<div>
